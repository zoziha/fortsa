...
contains
    ...
    subroutine test_model_autoarima1(error)
        ...
        line_num = countlines('example/data/seriesA.txt')
        open (newunit=unit, file='example/data/seriesA.txt')
    ...
    subroutine test_model_autoarima2(error)
        ...
        line_num = countlines('example/data/seriesG.txt')
        open (newunit=unit, file='example/data/seriesG.txt')
    ...
    subroutine test_model_autoarima3(error)
        ...
        line_num = countlines('example/data/e1m.dat')
        open (newunit=unit, file='example/data/e1m.dat')
